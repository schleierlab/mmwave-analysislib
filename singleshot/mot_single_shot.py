...
processed_results_fname = bulk_gas_preproc.process_shot(cloud_fit='gaussian_uniform') # cloud_fit='gaussian' )
...
plotter.plot_mot_params(fig = subfigs[1], uniform=False)
