...
from analysislib.common.analysis_config import manta_mot_system, BulkGasAnalysisConfig
...
analysis_config = BulkGasAnalysisConfig(
    imaging_system= manta_mot_system,
...
# analysis_config = BulkGasAnalysisConfig(
#     imaging_system= manta_tweezer_system,
#     exposure_time=1e-3,
