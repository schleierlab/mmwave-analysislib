...
roi_x = [850, 1250]#roi_x = [850, 1250] # Region of interest of X direction
roi_y = [650, 1050] #[750, 1150] # Region of interest of Y direction
...
electron_counts_mot = roi_MOT.max()
...
# raw_img_color_kw = dict(cmap='viridis', vmin=0, vmax=1000)
raw_img_color_kw = dict(cmap='viridis', vmin=0, vmax=image_scale)
