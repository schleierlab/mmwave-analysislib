...
# roi_x = [750, 1250] #roi_x = [750, 1250]#roi_x = [850, 1250] # Region of interest of X direction, MOT beam imaging
# roi_y = [800, 1000] #roi_y = [800, 1000] #[750, 1150] # Region of interest of Y direction, MOT beam imaging

roi_x = [900, 1050]#roi_x = [850, 1250] # Region of interest of X direction, Img beam imaging
roi_y = [850, 950] #[750, 1150] # Region of interest of Y direction, Img beam imaging
...
atom_number_withbkg = electron_counts_mot / counts_per_atom/roi_MOT.size
electron_counts_bkg = roi_bkg.sum()
bkg_number = electron_counts_bkg / counts_per_atom / roi_bkg.size  # average bkg floor in the size of roi_MOT
# atom_number = int(atom_number_withbkg)
atom_number = atom_number_withbkg
...
# raw_img_color_kw = dict(cmap='viridis', vmin=0, vmax=800)
# raw_img_color_kw = dict(cmap='viridis', vmin=0, vmax=image_scale)
...
if run_number == 0:
    with open(count_file_path, 'w') as f_object:
        f_object.write(f'{atom_number},{bkg_number}\n')
