...
from scripts.singleshot.tweezer_imaging_util import (
    ...
    plot_results, process_images, load_threshold, load_average_background,
    create_site_rectangles, save_data
)
...
def main():
    ...
    survival_rate = sum(1 for x,y in zip(atom_exist_lst_1,atom_exist_lst_2) 
