...
do_dipole_trap_analysis = True
# Constants
px = 1 #6.5 # Pixels size
mag = 1 #18.56 #7.424 #12.37 # Magnefication
counts_per_atom = 1 # Counts per atom 16.6 counts per atom per ms

if do_dipole_trap_analysis:
    roi_x = [750, 1250]#roi_x = [850, 1250] # Region of interest of X direction, MOT beam imaging
    roi_y = [800, 1000] #[750, 1150] # Region of interest of Y direction, MOT beam imaging
else:
    show_site_roi = False
    load_roi = True
