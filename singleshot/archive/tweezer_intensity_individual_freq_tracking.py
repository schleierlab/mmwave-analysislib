...
site_roi_x_min = np.array((np.min(site_roi_x[:,0]) + np.min(site_roi_x[:,1]))/2, dtype=np.int)
site_roi_x_max = np.array((np.max(site_roi_x[:,0]) + np.max(site_roi_x[:,1]))/2, dtype=np.int)
site_roi_y_min = np.array((np.min(site_roi_y[:,0]) + np.min(site_roi_y[:,1]))/2, dtype=np.int)
site_roi_y_max = np.array((np.max(site_roi_y[:,0]) + np.max(site_roi_y[:,1]))/2, dtype=np.int)

sites_num_step = 2
sites_size = 20
site_roi_x_new = np.array(np.stack((np.arange(site_roi_x_min - sites_size/2, site_roi_x_max-sites_size/2, sites_num_step)
                           ,np.arange(site_roi_x_min+sites_size/2, site_roi_x_max+sites_size/2, sites_num_step)), axis=-1), dtype=np.int)
site_roi_y_new = np.array(np.stack((np.arange(site_roi_y_max - sites_size/2, site_roi_y_min - sites_size/2, -sites_num_step)
                           ,np.arange(site_roi_y_max +sites_size/2, site_roi_y_min + sites_size/2, -sites_num_step)), axis=-1), dtype=np.int)


site_roi_x = site_roi_x_new
site_roi_y = site_roi_y_new
...
roi_number_lst = np.array(roi_number_lst)
...
roi_number_lst = roi_number_lst.reshape(1, roi_number_lst.shape[0], 1)
