...
roi_x = [750, 1350] #roi_x = [750, 1250]#roi_x = [850, 1250] # Region of interest of X direction, MOT beam imaging
roi_y = [800, 1050] #roi_y = [800, 1000] #[750, 1150] # Region of interest of Y direction, MOT beam imaging
...
raw_img_color_kw = dict(cmap='viridis', vmin=0, vmax=100)
# raw_img_color_kw = dict(cmap='viridis', vmin=0, vmax=image_scale)
