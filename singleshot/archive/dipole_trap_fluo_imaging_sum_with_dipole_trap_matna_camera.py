...
roi_x = [0, 2048] #[0, 2560] # Region of interest of X direction
roi_y = [0, 2048] #[0, 2560] # Region of interest of Y direction
...
with h5py.File(h5_path, mode='r+') as f:
    ...
    images = hz.datasetsToDictionary(f['manta419b_dipole_trap_images'], recursive=True)
