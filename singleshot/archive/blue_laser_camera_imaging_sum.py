...
roi_x = [0, 2048] # Region of interest of X direction
roi_y = [0, 1088] # Region of interest of Y direction
roi_x_bkg = [1548, 2048] # Region of interest of X direction
roi_y_bkg= [588, 1088] # Region of interest of Y direction
...
with h5py.File(h5_path, mode='r+') as f:
    ...
    images = hz.datasetsToDictionary(f['manta419b_blue_laser_images'], recursive=True)
...
count_file_path = folder_path+'\\blue_laser_data.csv'
