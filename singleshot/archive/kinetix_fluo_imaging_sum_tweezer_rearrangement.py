...
first_image_bkg_file_path = folder_path+'\\first'
second_image_bkg_file_path = folder_path+'\\seconds'
...
if run_number % 2 == 0: # even run number case, taking bkg
    first_image_bkg = images[image_types[0]]
    second_image_bkg = images[image_types[1]]

    np.save(first_image_bkg_file_path, first_image_bkg)
    np.save(second_image_bkg_file_path, second_image_bkg)
    ...
    frist_image_bkg_load_file_path = first_image_bkg_file_path + '.npy'
    second_image_bkg_load_file_path = second_image_bkg_file_path + '.npy'

    first_image_bkg = np.load(frist_image_bkg_load_file_path)
    second_image_bkg = np.load(second_image_bkg_load_file_path)
