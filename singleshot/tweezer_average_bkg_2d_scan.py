...
from tweezer_image_analysis import TweezerImageAnalyzer, AverageBackgroundAnalyzer, AverageBackground2DScanAnalyzer
...
def main():
    # Initialize analyzer
    analyzer = AverageBackground2DScanAnalyzer(
