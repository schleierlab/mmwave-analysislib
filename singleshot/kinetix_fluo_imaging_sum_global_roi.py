...
with h5py.File(h5_path, mode='r+') as f:
    ...
    roi_y = np.array((hz.attributesToDictionary(f).get('globals').get('kinetix_roi_row')))
...
image_scale = 2000 #4096 #2000 #4096 # 12 bit depth
