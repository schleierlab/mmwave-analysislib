...
fig, axs = plt.subplots(nrows=4, ncols=1, layout='constrained')  # 3 plots in one row
...
tweezer_statistician.plot_rearrange_site_success_rate(target_array, ax = axs[2])
tweezer_statistician.plot_site_loading_rates(ax = axs[3])
plt.tight_layout()
plt.show()
